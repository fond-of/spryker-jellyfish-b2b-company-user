 ...
 */
class JellyfishB2BCompanyUserCompanyUserCustomerExpanderPlugin extends AbstractPlugin implements CompanyUserExpanderPluginInterface
{
    /**
    ...
    public function expand(
        ...
        return $this->getFacade()->expandCompanyUserWithCustomer($companyUserTransfer);
    }
}
