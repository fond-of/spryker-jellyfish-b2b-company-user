 ...
 */
class JellyfishB2BCompanyUserCompanyUserCompanyExpanderPlugin extends AbstractPlugin implements CompanyUserExpanderPluginInterface
{
    /**
    ...
    public function expand(
        ...
        return $this->getFacade()->expandCompanyUserWithCompany($companyUserTransfer);
    }
}
